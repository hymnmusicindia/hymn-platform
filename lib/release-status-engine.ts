...
const allowedTransitions: Partial<Record<ReleaseStatus, ReleaseStatus[]>> = {
  ...
  under_review: ["draft", "changes_requested", "approved", "rejected", "delivery_failed"], changes_requested: ["draft", "resubmitted", "rejected"], resubmitted: ["in_qc_queue", "under_review"], rejected: ["draft", "resubmitted"],
  approved: ["changes_requested", "rejected", "queued_for_distribution", "submitting_to_distributor", "sent_to_distributor", "failed"], queued_for_distribution: ["submitting_to_distributor", "sent_to_distributor", "delivery_failed"], submitting_to_distributor: ["queued_for_distribution", "sent_to_distributor", "changes_requested", "delivery_failed"],
  ...
  delivered: ["partially_live", "live", "delivery_failed"], sent: ["queued_for_distribution", "submitting_to_distributor", "scheduled", "awaiting_live_confirmation", "partially_live", "delivery_failed"], failed: ["under_review", "queued_for_distribution"], delivery_failed: ["in_qc_queue", "queued_for_distribution", "archived"], live: ["takedown_requested", "archived"], partially_live: ["live", "delivery_failed", "takedown_requested"], takedown_requested: ["takedown_processing"], takedown_processing: ["taken_down", "delivery_failed"], taken_down: ["archived"]
};
