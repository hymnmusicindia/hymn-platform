...
export function BeatCard({ beat, active = false, playing = false, onPlay, onAdd, onLicense, generalInCart = false, exclusiveInCart = false }: {
  beat: ExtendedBeatCardData; active?: boolean; playing?: boolean; onPlay?: () => void; onAdd?: (licenseType: "general" | "exclusive") => void; onLicense?: (licenseType: "general" | "exclusive") => void; generalInCart?: boolean; exclusiveInCart?: boolean;
}) {
