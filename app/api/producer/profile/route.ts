...
export async function GET() {
  ...
  return NextResponse.json({ profile: await prisma.producerProfile.findUnique({ where: { userId: result.user.id }, include: { contributorParty: { select: { publicId: true, identityState: true } } } }) });
}
