...
async function main() {
  ...
  const appointmentInput = {
    userId: appointedUser.id, professionalName: "Appointed Engineer", slug: `appointed-engineer-${stamp}`, profilePhotoUrl: null, bio: "An experienced mix engineer appointed through Studio operations.", specialties: ["Mixing", "Mastering"], genres: ["Pop", "R&B"], socialLinks: { instagram: "https://instagram.com/example", youtube: "https://youtube.com/@example" }, portfolioItems: [{ title: "Before and after mix", url: "https://example.com/mix.wav" }], availability: "AVAILABLE" as const, maxActiveOrders: 4, verificationState: "VERIFIED" as const, sellerState: "ACTIVE" as const, payoutState: "PENDING" as const,
