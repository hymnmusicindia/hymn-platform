    ...
    <main className="pb-20">
      <section className="relative overflow-hidden border-b" style={{ borderColor: "var(--border)" }}>
        ...
        <div className="shell relative z-10 py-16 text-white sm:py-20">
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-[minmax(0,1.2fr)_minmax(260px,0.7fr)] lg:items-end">
            <div>
              <p className="text-xs font-semibold uppercase tracking-[0.3em] text-white/60">Curated producer profile</p>
              <h1 className="mt-4 text-4xl font-semibold tracking-tight sm:text-5xl">{producer.name}</h1>
      ...
      <section className="shell py-16">
        <div className="mb-8 max-w-3xl">
          <span className="eyebrow">Producer catalog</span>
