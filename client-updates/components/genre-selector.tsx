...
export const genreCatalog = [
  { genre: "Hip-Hop", subgenres: ["Drill", "Boom Bap", "Trap"] },
  { genre: "Pop", subgenres: ["Indie Pop", "Synth Pop", "Dance Pop"] },
  { genre: "Electronic", subgenres: ["House", "Techno", "Garage"] },
  { genre: "R&B", subgenres: ["Alternative R&B", "Soul", "Neo Soul"] }
] as const;
