...
type CheckoutItem =
  ...
  | { type: "distribution"; plan: "pay_per_release" | "basic" | "pro"; trackCount: number; platforms: string[]; youtubeContentIdEnabled?: boolean };
...
function defaultItems(product?: string | null): CheckoutItem[] {
  if (product === "subscription-basic") {
    return [{ type: "distribution", plan: "basic", trackCount: 1, platforms: ["Spotify", "Apple Music"] }];
  }
  if (product === "subscription-pro") {
    return [{ type: "distribution", plan: "pro", trackCount: 1, platforms: ["Spotify", "Apple Music"] }];
  }
  return [{ type: "distribution", plan: "pay_per_release", trackCount: 1, platforms: ["Spotify", "Apple Music"] }];
}
    ...
    <section className="shell py-10">
      <div className="grid gap-6 lg:grid-cols-[1.1fr,0.9fr]">
        <div className="surface-card p-6 sm:p-8">
          ...
          <h1 className="mt-4 text-4xl font-semibold" style={{ color: "var(--text)" }}>Review before payment.</h1>
        ...
        <aside className="surface-card self-start p-6 sm:p-8">
          <div className="flex items-center gap-2">
            ...
            <span className="eyebrow">Backend validated</span>
          </div>
